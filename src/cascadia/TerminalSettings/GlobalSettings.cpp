...
std::wstring GlobalSettings::UnparsedDefaultProfile() const
{
...
void GlobalSettings::LayerJson(const Json::Value& json)
{
    ...
    // TODO CARLOS: Figure out Json ConversionTrait
    ...
    // TODO CARLOS: Linker issue with ElementTheme
    //JsonUtils::GetValueForKey(json, ThemeKey, _Theme);

    // TODO CARLOS: Microsoft.UI.Xaml.Controls.TabViewWidthMode not recognized
