...
template<>
struct ::winrt::Microsoft::Terminal::Settings::Model::JsonUtils::ConversionTrait<::winrt::Windows::UI::Text::FontWeight> :
    public ::winrt::Microsoft::Terminal::Settings::Model::JsonUtils::EnumMapper<
        unsigned int,
        ::winrt::Microsoft::Terminal::Settings::Model::JsonUtils::ConversionTrait<::winrt::Windows::UI::Text::FontWeight>>
{
...
JSON_ENUM_MAPPER(::winrt::Microsoft::Terminal::Settings::Model::AppLaunchMode)
{
    JSON_MAPPINGS(3) = {
...
// TODO CARLOS: figure out how to import winrt/Microsoft.UI.Xaml.Controls
/*
...
template<>
struct ::winrt::Microsoft::Terminal::Settings::Model::JsonUtils::ConversionTrait<::winrt::Microsoft::Terminal::Settings::Model::LaunchPosition>
{
