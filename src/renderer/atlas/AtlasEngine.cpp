...
namespace
{
    ...
    AtlasEngine::CustomShaderTexture LoadCustomShaderTexture(
        ID3D11Device* d3dDevice,
        ID3D11DeviceContext* d3dContext,
        const std::wstring& fileName)
    {
        AtlasEngine::CustomShaderTexture empty;
...
void AtlasEngine::_createResources()
{
    ...
    if (!_r.d2dMode)
    {
        ...
        {
            _r.customShaderTexture = LoadCustomShaderTexture(
                _r.device.get(),
        ...
        {
            _r.customShaderTexture = CustomShaderTexture();
        }
