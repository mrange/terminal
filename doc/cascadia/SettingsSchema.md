...
| `experimental.pixelShaderEffect` | Optional | String | `` | If set to a file name, compiles said file as a pixel shader effect and applies it the terminal view. This is an experimental feature, and its continued existence is not guaranteed. |
